...
QString OmarchyThemeTest::writeColors(const QString &name, const QString &contents) {
...
void OmarchyThemeTest::initTestCase() { QVERIFY(m_dir.isValid()); }

void OmarchyThemeTest::parsesQuotedUnquotedCommentsAndBlankLines() {
...
void OmarchyThemeTest::ignoresUnknownKeysAndInvalidColors() {
...
void OmarchyThemeTest::fallsBackToDefaultsPerMode() {
...
void OmarchyThemeTest::readsModeFromTheFile() {
...
void OmarchyThemeTest::guessesModeFromBackgroundLuminance() {
...
void OmarchyThemeTest::keepsModeWhenTheFileSaysNothing() {
...
void OmarchyThemeTest::missingFileLeavesEveryColorAtItsDefault() {
    OmarchyTheme theme;
    theme.setDarkMode(true);
...
void OmarchyThemeTest::setColorsPathReloadsAndSignals() {
...
void OmarchyThemeTest::settersOnlySignalOnChange() {
    OmarchyTheme theme;
...
void OmarchyThemeTest::colorFallsBackToTheForeground() {
...
void OmarchyThemeTest::mixBlendsAndClamps() {
...
void OmarchyThemeTest::alphaSetsAndClamps() {
