...
void KeyTests::plainDigitKeysResolve() {
...
void KeyTests::shiftedDigitsResolveOnUsLayouts() {
...
void KeyTests::modifiersAndOtherKeysResolveToNothing() {
...
void KeyTests::theBridgeAnswersTheSameAsTheHelper() {
    SudokuGame game;
...
void KeyTests::aShiftHeldSweepNeverWritesANote() {
    SudokuGame game;
