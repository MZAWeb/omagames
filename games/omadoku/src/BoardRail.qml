...
// The rail beside the board: the digits, what a digit does, validation, the
// secondary actions and a one-line key reminder — always in that order, so
// nothing a hand has learned moves when the puzzle or the window changes.
ColumnLayout {
    id: rail
    ...
    readonly property real keyBudget: height - modes.implicitHeight - validate.implicitHeight
        - actions.implicitHeight - reminder.implicitHeight - 5 * spacing
